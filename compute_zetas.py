...
parser.add_argument('-q', dest='q', type=int, help='Modulus q', default=18446744073709550593)
parser.add_argument('-zeta', dest='zeta', type=int, help='2nth root of unity', default=12400524647368804660)
